...
import 'package:flutter_audio_service_demo/missing_data_alert.dart';
...
CatcherOptions debugOptions =
      CatcherOptions(PageReportMode(showStackTrace: true), [EmailManualHandler(["kumar.jayanti@gmail.com"])]);
      
  /// Release configuration. Same as above, but once user accepts dialog, user will be prompted to send email with crash to support.
  CatcherOptions releaseOptions = CatcherOptions(PageReportMode(showStackTrace: true), [
...
class _MyAppState extends State<MyApp> {
  ...
  String _last_updated = 'https://storage.googleapis.com/vasis/last_updated.txt';
                        ...
                        return Card(
                          ...
                          child: ListTile(
                              onTap: () => {
                                    ...
                                    print("######## begin #######"),
                                    print(
                                        "On Pressed prev _selectedIndex=${_selectedIndex}"),
                                    print("On Pressed index=$index"),
                                    print(
                                        "On Pressed playlist id=${playlistTitles[index].id}"),
                                    print(
                                        "On Pressed playlist title=${playlistTitles[index].title}"),
                                        */
                                    //_selectedIndex = int.parse(playlistTitles[index].id),
                                    ...
                                    /*
                                    print(
                                        "On Pressed current _selectedIndex=$_selectedIndex"),
                                    print("####### end ########\n"),
                                    */
                              ...
                              leading: CircleAvatar(
                                backgroundImage:
                                    AssetImage('images/kartal.jpeg'),
                                radius: _selectedIndex == index ? 15 : 9,
                              ),
      ...
      child: ValueListenableBuilder<List<String>>(
        ...
        builder: (context, playlistTitles, _) {
          return ListWheelScrollView(
            ...
            children: <Widget>[
                  for (int i = 0; i < 17; i++) Card(child:ListTile(
                title: Text(
                  '${playlistTitles[i]}',
                  style: TextStyle(
                    fontSize: 15,
                ...
                trailing: Icon(Icons.queue_music_rounded, color:Colors.blue),
                leading: CircleAvatar(backgroundImage: AssetImage('images/kartal.jpeg'), radius : 14
              ),
